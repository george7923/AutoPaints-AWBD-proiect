...
- Create Angular project with ng: `ng new licentainangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`licentainangular.client.esproj`).
